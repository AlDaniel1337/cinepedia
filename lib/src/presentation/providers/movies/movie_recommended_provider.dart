//===========================================================
//* MANEJAR PETICIONES PARA OBTENER PELICULAS RECOMENDADAS
...
final recommendedMoviesProvider = StateNotifierProvider<MovieMapNotifier, Map< String, List<Movie> >>( (ref) {

  //* Obtener funcion principal para acceder a los metodos del [RepositoryImpl]
  final movieRepository = ref.watch( movieRepositoryProvider );

  return MovieMapNotifier(
    getMovies: movieRepository.recommendedMovies
  );
});
